...
//
//                    sessionManager.saveSession(uid, newTokenResponse.token,newTokenResponse.refreshToken)
//
...
//            try {
//                Log.e("DataBaseRep","the fcm token fun calling")
...
//                        Log.e(
//                            "DataBaseRep",
//                            "The Token Saved in Local ${sessionManager.getAccessToken()} and ${response.refreshToken}"
//                        )
...
//                    sessionManager.saveSession(receiverUid, response.token,response.refreshToken)
//
...
class DataBaseRep @Inject constructor(
    ...
    suspend fun signIn(data: SignInData): Result<UserSession> {
        return try {
            ...
            Log.e("DataBaseRep","The SignIn Failed Cuz of $e")
            Result.failure(e)
        }
    }
